...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Document settings
\title{Real-Time Human Recognition \& Fall Detection Using mmWave Radar}
\subCode{XX367P}
...
\stuNameA{Nikhil A E}
\stuUSNA{1RV23EC089}
\stuNameB{Poornachandra B R}
\stuUSNB{1RV23EC095}
\stuNameC{Spoorthy S}
\stuUSNC{1RV23CS305}
\stuNameD{Chirag S Shetty}
\stuUSND{1RV23CS077}
...
%% Pannel Members %%
\panelMemberNameA{Dr. B S Kariyappa}
...
\projectCoOrdNameA{Prof. Sujata Priyambada Mishra}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%  QRL %%%%%%%%%%%%%%%%%%%%%%%%%%
\QRurl{https://drive.google.com/drive/folders/1Hb3RMCByL-FEbad4mX8AuX8Cj8I1Lwot?usp=sharing}
